...
SMG63 = URLDependency('https://github.com/Lord-Giganticus/SMG63-Patcher/releases/download/v1.0/SMG63.zip')
...
if __name__ == "__main__":
    ...
    print("Copying SMG63 files to extracted SMG2...")

    orig = Path('smg2.d\\files').absolute()

    smg63 = Path('SMG63').absolute()

    shutil.copytree(smg63, orig, dirs_exist_ok=True)
    ...
    WIT.execute('copy smg2.d "SMG63.wbfs" -ovv --id=....01 --name="SMG63"')
